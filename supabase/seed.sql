...
INSERT INTO pricing_implants (sub_category, type, base_price) VALUES
  ('Robotic', 'Crown', 10.00),
  ('Robotic', 'Bridge', 10.00),
  ('Custom', 'Crown', 10.00),
  ('Custom', 'Bridge', 10.00),
  ('Ti-Base', 'Crown', 10.00),
  ('Ti-Base', 'Bridge', 10.00),
  ('Ti-Base', 'On-Lay', 10.00)
...
INSERT INTO pricing_appliances (appliance_type, occlusion_type, arch, total_price) VALUES
  -- Night Guards
  ('Night Guards', 'Even Occlusion', 'Upper', 10.00),
  ('Night Guards', 'Even Occlusion', 'Lower', 10.00),
  ('Night Guards', 'Even Occlusion', 'Both Arches', 20.00),
  ('Night Guards', 'Custom', 'Upper', 15.00),
  ('Night Guards', 'Custom', 'Lower', 15.00),
  ('Night Guards', 'Custom', 'Both Arches', 25.00),
  -- Spot Guards
  ('Spot Guards', 'Even Occlusion', 'Upper', 10.00),
  ('Spot Guards', 'Even Occlusion', 'Lower', 10.00),
  ('Spot Guards', 'Even Occlusion', 'Both Arches', 20.00),
  ('Spot Guards', 'Custom', 'Upper', 15.00),
  ('Spot Guards', 'Custom', 'Lower', 15.00),
  ('Spot Guards', 'Custom', 'Both Arches', 25.00),
  -- Sports Guard
  ('Sports Guard', NULL, 'Upper', 10.00),
  ('Sports Guard', NULL, 'Lower', 10.00),
  ('Sports Guard', NULL, 'Both Arches', 20.00),
  -- Mouth Guards
  ('Mouth Guards', NULL, 'Upper', 10.00),
  ('Mouth Guards', NULL, 'Lower', 10.00),
  ('Mouth Guards', NULL, 'Both Arches', 20.00),
  -- NTI
  ('NTI', NULL, 'Upper', 10.00),
  ('NTI', NULL, 'Lower', 10.00),
  ('NTI', NULL, 'Both Arches', 20.00)
