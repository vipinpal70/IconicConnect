...
const initial: FormData = {
  ...
  labName: '', postalCode: '', city: '', state: '', country: '',
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="w-full max-w-md bg-white rounded-2xl border border-gray-100 p-8 text-center">
          ...
          <Link href="/auth/sign-in" className="mt-6 inline-block text-sm text-teal-600 font-medium hover:underline">
            Back to sign in
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-2xl bg-white rounded-2xl border border-gray-100 p-8">
        ...
        <div className='flex justify-between items-start mb-6'>
          ...
          <div className="">
            <h2 className="text-xl font-semibold text-gray-900">Please register here!</h2>
            <p className="text-sm text-gray-400">Join the network — fill in your details below</p>
          </div>
        </div>
        ...
        {/* <div className="flex gap-1.5 my-5">
          {[1, 2, 3].map(i => (
            <div key={i} className={`h-1 flex-1 rounded-full ${i <= 2 ? 'bg-teal-500' : 'bg-gray-100'}`} />
          ))}
        </div> */}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-black">
              <Field label="Lab name" name="labName" value={form.labName} onChange={handleChange} />
