...
First read my exiting code for this feature
show a table form of all saved preference from
by default a system assigned preference from will be auto generated and added to each client

so i will provide you a complete details of preference form
divide it itno 4 steps

Below are all the fields in the **Client Design Preference Form**, including their **input types** and **default values** as shown in the PDF.

| #      | Field                                        | Input Type                                                  | Default Value                  |
| ------ | -------------------------------------------- | ----------------------------------------------------------- | ------------------------------ |
| Header | Lab Name                                     | Text                                                        | Empty                          |
| Header | Contact                                      | Text                                                        | Empty                          |
| Header | Phone                                        | Text                                                        | Empty                          |
| Header | Phone                                        | Text                                                        | Empty                          |
| 1      | Occlusion                                    | Numeric                                                     | **0.4**                        |
| 2      | Proximal Contacts                            | Numeric                                                     | **0.02**                       |
| 3      | Contact for Distal-most Crown                | Text                                                        | None                           |
| 4      | Anatomy                                      | Radio (Primary Only / Secondary / Match Adjacent)           | **Match Adjacent**             |
| 5      | Smile Library (Posterior)                    | Radio (CAP / Lab Preference)                                | **CAP (Default)**              |
| 5      | Smile Library (Anterior)                     | Radio (Glidewell / Lab Preference)                          | **Glidewell (Default)**        |
| 6      | Pontic Type                                  | Radio (Ovate / Modified Ovate / Modified Ridge Lap / Other) | **Modified Ridge Lap**         |
| 7      | Pontic Distance from Tissue                  | Radio + Numeric                                             | **Into 0.15 mm**               |
| 8      | Match Marginal Ridge to Occlusal of Opposing | Yes / No                                                    | **Yes**                        |
| 9      | Posterior Cutback                            | Radio                                                       | **Buccal Surface Only**        |
| 10     | Anterior Cutback                             | Radio                                                       | **With Mamelons**              |
| 11     | Pontic Distance from Tissue (Coping)         | Flush / Off **_ mm / Into _** mm                            | No default selected            |
| 12     | Collar Type                                  | Radio (No Collar / Lingual Collar / 360 Collar)             | None                           |
| 13     | Create Island – Limited Space                | Yes / No                                                    | None                           |
| 14     | Gingiva Levels                               | Numeric (Anterior & Posterior)                              | See note below                 |
| 15     | Distance to Antagonist                       | Radio                                                       | **Default 2.0–2.5 mm**         |
| 16     | Identification Dots                          | Yes / No                                                    | None                           |
| 17     | Internal Retention Groove                    | Yes / No                                                    | None                           |
| 18     | Taper Angle                                  | Radio                                                       | **Default 3°**                 |
| 19     | Emergence Profile                            | Radio                                                       | **Default – Concave**          |
| 20     | Screw-retained Crown                         | Radio                                                       | **Default Hole Size – 2.5 mm** |

### Gingiva Levels (Field 14)
...
1. **Gingiva Level defaults**
   - Buccal: **1.0 mm**
   - Lingual: **0.5 mm**
   - Mesial & Distal: **0.5 mm**

2. **Please send DME files for**
   - Material Settings
   - Manufacturing Settings

### Fields with no predefined default

- Contact for Distal-most Crown
- Pontic Distance from Tissue (Coping)
- Collar Type
- Create Island – Limited Space
- Identification Dots
- Internal Retention Groove
- All Comments fields
- Header fields (Lab Name, Contact, Phone)

The defaults above are based on the checkboxes marked with an **"X"** and the printed default values shown in the form.

in the client/preferences
first read exiting code related to this
and addon the missing things only
do not remove anythings

so first create a Preferences Form plan.md file
then wait for my approval to start implementing this

#### Add a new column in price list for design+milling price

### same thinngs in system default list as well as

- impact:
  billing and invoice - filter by case service type -
  - pdf
  - price list update and proper sync with redis and cdn
  - hard refresh button, fetch from db directly and update redis chache and cdn
