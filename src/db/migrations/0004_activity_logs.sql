...
--> statement-breakpoint
CREATE INDEX "activity_logs_case_idx" ON "activity_logs" USING btree ("case_id");
--> statement-breakpoint
CREATE INDEX "activity_logs_user_idx" ON "activity_logs" USING btree ("user_id");
--> statement-breakpoint
CREATE INDEX "activity_logs_action_at_idx" ON "activity_logs" USING btree ("action_at");
