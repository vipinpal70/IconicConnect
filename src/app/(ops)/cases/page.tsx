          ...
          <CardContent className="p-3 space-y-2.5">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 pt-2 border-t border-border/50">
              ...
              <div className="flex gap-2 sm:ml-auto">
                <Button size="sm" variant="secondary" className="h-8 text-xs font-semibold" onClick={() => applyFilters()}>Apply</Button>
                <Button size="sm" className="h-8 text-xs font-semibold gap-1.5" onClick={() => void runFetch()} disabled={isFetching}>
